...
import userImage from '../images/hamza6.png';
import AOS from 'aos';
      ...
      <div className="aboutContainer ">
        ...
        <div className='aboutContant'>
          ...
          <div className='btn-resume-container'>
            <a href="https://www.fiverr.com/ameerhamza2090" className='btn-resume hvr-bounce-to-right' target='_blank'>Hire me</a>
          </div>

          <div className='btn-resume-container'>
            <a href="https://firebasestorage.googleapis.com/v0/b/hackthon-of-react-js.appspot.com/o/CV%20copy.pdf?alt=media&token=26a41c4b-a76e-4c0f-af08-a1754229908d" className='btn-resumes hvr-bounce-to-right' target='_blank'>View Resume</a>
          </div>
        </div>
      </div>
